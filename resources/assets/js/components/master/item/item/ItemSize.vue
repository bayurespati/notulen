<template>
    <div class="panel-heading row">
        <div class="row mr-0 ml-0 mt-5 mb-4 pt-3 pb-3 bg-grey col-sm-12">
            ...
            :class="errors.dimension ? 'has-danger' : ''">
            ...
            <div class="col-sm-6 offset-3 d-flex justify-content-around mt-3">
                <div class="col-sm-6">
